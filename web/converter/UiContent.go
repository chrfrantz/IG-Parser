...
var HELP_CODED_STMT = "The <em>'Encoded Statement'</em> field is where the actual encoding of the institutional statement in the IG-Script syntax occurs." + LINEBREAK + LINEBREAK +
	...
	"Additional features include the use of suffices to indicate private linkages between properties and associated components (e.g., " + HTML_EM_START + "Bdir,p1(violating) Bdir1(citizens)" + HTML_EM_STOP + " as well as " + HTML_EM_START + "Bdir,p2(compliant) Bdir2(customers)" + HTML_EM_STOP + ")." + LINEBREAK + LINEBREAK +
	...
	"Such annotations can be combined with suffices indicating private component relationships (e.g., " + HTML_EM_START + "A,p1[prop=qualitative](personal) A1[type=animate](agent)" + HTML_EM_STOP + ")." + LINEBREAK + LINEBREAK +
